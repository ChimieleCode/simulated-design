...
class BeamDeatailsRD39:
    ...
    def get_shear_strirrups_share() -> float:
        """
        Minimum share of shear action that have to be taken by stirrups.
...
class BeamDeatailsDM76:
    ...
    def get_shear_strirrups_share() -> float:
        """
        Minimum share of shear action that have to be taken by stirrups. Par 2.4.1
    ...
    def get_min_long_rebar_area(
        ...
        """
        Minimum bottom reinforcement area in m2 based on DM 76 Par 2.17.
...
class ColumnDeatailsRD39:
    ...
    def compute_min_long_reinf_area(
        ...
        :param column_min_cls_area: minimum stritly necessary area in m2.
    ...
    def check_section(
        ...
        :param section: The section to be checked.
        :param min_cls_area: Minimum cls area in m2.
        :return: True if the section meets the requirements, False otherwise.
        """
...
class ColumnDeatailsDM76:
    ...
    def compute_min_long_reinf_area(
        ...
        :param column_area: column area in m2.
        :param column_min_cls_area: minimum stritly necessary area in m2.
        :return: minimum longitudinal reinforcement area in m2.
        """
        return max(
    ...
    def compute_max_long_reinf_area(
        ...
        :param column_area: column area in m2.
        :param column_min_cls_area: minimum stritly necessary area in m2.
        :return: maximum longitudinal reinforcement area in m2.
        """
    ...
    def check_section(
        ...
        :param section: The section to be checked.
        :param column_min_cls_area: Minimum class area in m2.
        :return: True if the section meets the requirements, False otherwise.
        """
        # Check minimum longitudinal bar diameter
        if min(section.bot_reinf_d, section.top_reinf_d) < cls.get_min_rebar_diameter():
        ...
        if section.bot_reinf_area + section.top_reinf_area < min_reinf_area:
            print('Failed due to minimum reinforcement area')
            return False
...
def get_min_longitudinal_bar_area_column(
    ...
    if detailing_code == DetailingCode.RD_39:
        return ColumnDeatailsRD39.compute_min_long_reinf_area(
            column_min_cls_area
        )
    elif detailing_code == DetailingCode.DM_76:
        return ColumnDeatailsDM76.compute_min_long_reinf_area(
            column_area,
            column_min_cls_area
        )
    else:
...
def column_section_detail_checker(
    ...
    """
    if detailing_code == DetailingCode.RD_39:
        return ColumnDeatailsRD39.check_section(
            section=section,
            min_cls_area=min_cls_area
        )
    elif detailing_code == DetailingCode.DM_76:
        return ColumnDeatailsDM76.check_section(
            section=section,
...
def beam_section_detail_checker(
    ...
    """
    if detailing_code == DetailingCode.RD_39:
        return BeamDeatailsRD39.check_section(
            section=section
        )
    elif detailing_code == DetailingCode.DM_76:
        return BeamDeatailsDM76.check_section(
            section=section,
            rebar_type=rebar_type
        )
    else:
